...
public class QuizActivity extends AppCompatActivity {
    ...
    private void showResult() {
        ...
        intent.putExtra("questions", QuizData.getQuestionsSubset(randomQuestionIndexes, "space"));
        intent.putExtra("selectedAnswers", selectedAnswers);
        intent.putExtra("correctAnswers", QuizData.getCorrectAnswersSubset(randomQuestionIndexes, "space"));
        intent.putExtra("options", QuizData.options_space);
