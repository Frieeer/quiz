...
public class RandomQuizActivity extends AppCompatActivity {
    ...
    private int[] selectedAnswers = new int[40];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randomQuestionIndexes = QuizData.getRandomQuestionsIndexes(40, themeType);
        showQuestion();
    ...
    private void showResult() {
        ...
        Intent intent = new Intent(RandomQuizActivity.this, ResultActivity.class);
        intent.putExtra("questions", QuizData.getQuestionsSubset(randomQuestionIndexes, "random"));
        intent.putExtra("selectedAnswers", selectedAnswers);
        intent.putExtra("correctAnswers", QuizData.getCorrectAnswersSubset(randomQuestionIndexes, "random"));
        intent.putExtra("options", QuizData.options_random);
